    ...
    public static void main (String [] args) {
        ...
        try {
            ...
            if (index == 0) //Se houver apenas um número ele será o menor
                ...
                System.out.print(menor_n(v, index - 1, v[0]));
        }catch (Error | Exception e) {
            System.out.print("ERRO, tente com valores válidos!");
        }
    }

    public static double menor_n(Double[] v, int aux, Double aux_2) {
        return aux == 0? aux_2 : aux_2 > v[aux]? aux_2 = v[aux] : menor_n(v, aux - 1, aux_2);
    } //'aux.' diferente de início do array? Verifique aux_2 até alcançar o menor número presente.
}
